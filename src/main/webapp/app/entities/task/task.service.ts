...
export class TaskService {
    ...
    private convertDateFromClient(task: ITask): ITask {
        const copy: ITask = Object.assign({}, task, {
            startDate: task.startDate != null && task.startDate.isValid() ? task.startDate.format(DATE_FORMAT) : null,
            endDate: task.endDate != null && task.endDate.isValid() ? task.endDate.format(DATE_FORMAT) : null
        });
        return copy;
    }
