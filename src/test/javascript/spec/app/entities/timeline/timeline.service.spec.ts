    ...
    describe('Timeline Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/timelines';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Timeline', () => {
                service.create(new Timeline(null)).subscribe(received => {
            ...
            it('should update a Timeline', () => {
                service.update(new Timeline(123)).subscribe(received => {
            ...
            it('should return a list of Timeline', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Timeline(123)]);
            });
