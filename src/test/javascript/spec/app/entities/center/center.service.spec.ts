    ...
    describe('Center Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/centers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Center', () => {
                service.create(new Center(null)).subscribe(received => {
            ...
            it('should update a Center', () => {
                service.update(new Center(123)).subscribe(received => {
