    ...
    describe('Attendance Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/attendances';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Attendance', () => {
                service.create(new Attendance(null)).subscribe(received => {
            ...
            it('should update a Attendance', () => {
                service.update(new Attendance(123)).subscribe(received => {
