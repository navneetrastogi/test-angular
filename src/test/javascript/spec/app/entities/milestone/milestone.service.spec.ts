    ...
    describe('Milestone Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/milestones';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Milestone', () => {
                service.create(new Milestone(null)).subscribe(received => {
            ...
            it('should update a Milestone', () => {
                service.update(new Milestone(123)).subscribe(received => {
