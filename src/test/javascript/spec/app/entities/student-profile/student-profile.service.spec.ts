    ...
    describe('StudentProfile Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/student-profiles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a StudentProfile', () => {
                service.create(new StudentProfile(null)).subscribe(received => {
            ...
            it('should update a StudentProfile', () => {
                service.update(new StudentProfile(123)).subscribe(received => {
            ...
            it('should return a StudentProfile', () => {
            ...
            it('should return a list of StudentProfile', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new StudentProfile(123)]);
            });
