    ...
    describe('Incident Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/incidents';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Incident', () => {
                service.create(new Incident(null)).subscribe(received => {
            ...
            it('should update a Incident', () => {
                service.update(new Incident(123)).subscribe(received => {
