    ...
    describe('ActivityType Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/activity-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ActivityType', () => {
                service.create(new ActivityType(null)).subscribe(received => {
            ...
            it('should update a ActivityType', () => {
                service.update(new ActivityType(123)).subscribe(received => {
            ...
            it('should return a ActivityType', () => {
            ...
            it('should return a list of ActivityType', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ActivityType(123)]);
            });
