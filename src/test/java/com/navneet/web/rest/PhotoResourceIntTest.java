...
import com.navneet.domain.Photo;
import com.navneet.repository.PhotoRepository;
...
public class PhotoResourceIntTest {
    ...
    public void createPhoto() throws Exception {
        ...
        assertThat(testPhoto.getActivityId()).isEqualTo(DEFAULT_ACTIVITY_ID);
        assertThat(testPhoto.getEventId()).isEqualTo(DEFAULT_EVENT_ID);
    ...
    public void updatePhoto() throws Exception {
        ...
        Photo testPhoto = photoList.get(photoList.size() - 1);
        assertThat(testPhoto.getActivityId()).isEqualTo(UPDATED_ACTIVITY_ID);
        assertThat(testPhoto.getEventId()).isEqualTo(UPDATED_EVENT_ID);
