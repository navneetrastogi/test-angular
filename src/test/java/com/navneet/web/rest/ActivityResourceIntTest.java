...
import com.navneet.repository.ActivityRepository;
...
public class ActivityResourceIntTest {
    ...
    private static final String DEFAULT_ACTIVITY_IMAGE_URL = "AAAAAAAAAA";
    private static final String UPDATED_ACTIVITY_IMAGE_URL = "BBBBBBBBBB";
    ...
    public static Activity createEntity(EntityManager em) {
        Activity activity = new Activity()
            ...
            .activityImageUrl(DEFAULT_ACTIVITY_IMAGE_URL)
    ...
    public void createActivity() throws Exception {
        ...
        assertThat(testActivity.getActivityImageUrl()).isEqualTo(DEFAULT_ACTIVITY_IMAGE_URL);
        ...
        assertThat(testActivity.getLastModifiedOn()).isEqualTo(DEFAULT_LAST_MODIFIED_ON);
    }
    ...
    public void getAllActivities() throws Exception {
        ...
        restActivityMockMvc.perform(get("/api/activities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].activityImageUrl").value(hasItem(DEFAULT_ACTIVITY_IMAGE_URL.toString())))
    ...
    public void getActivity() throws Exception {
        ...
        restActivityMockMvc.perform(get("/api/activities/{id}", activity.getId()))
            ...
            .andExpect(jsonPath("$.activityImageUrl").value(DEFAULT_ACTIVITY_IMAGE_URL.toString()))
    ...
    public void updateActivity() throws Exception {
        ...
        updatedActivity
            ...
            .activityImageUrl(UPDATED_ACTIVITY_IMAGE_URL)
        ...
        assertThat(testActivity.getActivityImageUrl()).isEqualTo(UPDATED_ACTIVITY_IMAGE_URL);
        ...
        assertThat(testActivity.getLastModifiedOn()).isEqualTo(UPDATED_LAST_MODIFIED_ON);
    }
