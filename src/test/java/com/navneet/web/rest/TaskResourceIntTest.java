...
import com.navneet.domain.Task;
import com.navneet.repository.TaskRepository;
...
public class TaskResourceIntTest {
    ...
    private static final ReminderType DEFAULT_REMINDER_TYPE = ReminderType.HOURLY;
    private static final ReminderType UPDATED_REMINDER_TYPE = ReminderType.DAILY;
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getReminderType()).isEqualTo(DEFAULT_REMINDER_TYPE);
    }
    ...
    public void getAllTasks() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].reminderType").value(hasItem(DEFAULT_REMINDER_TYPE.toString())));
    }
    ...
    public void getTask() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks/{id}", task.getId()))
            ...
            .andExpect(jsonPath("$.reminderType").value(DEFAULT_REMINDER_TYPE.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getReminderType()).isEqualTo(UPDATED_REMINDER_TYPE);
    }
