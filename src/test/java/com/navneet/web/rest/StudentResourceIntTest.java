...
import com.navneet.domain.Student;
import com.navneet.repository.StudentRepository;
...
public class StudentResourceIntTest {
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getLastModifiedOn()).isEqualTo(DEFAULT_LAST_MODIFIED_ON);
    }
    ...
    public void updateStudent() throws Exception {
        ...
        assertThat(testStudent.getLastModifiedOn()).isEqualTo(UPDATED_LAST_MODIFIED_ON);
    }
