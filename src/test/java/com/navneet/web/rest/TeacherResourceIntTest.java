...
import com.navneet.domain.Teacher;
import com.navneet.repository.TeacherRepository;
...
public class TeacherResourceIntTest {
    ...
    public void createTeacher() throws Exception {
        ...
        assertThat(testTeacher.getContactNumber()).isEqualTo(DEFAULT_CONTACT_NUMBER);
        assertThat(testTeacher.getGender()).isEqualTo(DEFAULT_GENDER);
        assertThat(testTeacher.getAddress()).isEqualTo(DEFAULT_ADDRESS);
        assertThat(testTeacher.getCreatedOn()).isEqualTo(DEFAULT_CREATED_ON);
    ...
    public void updateTeacher() throws Exception {
        ...
        assertThat(testTeacher.getContactNumber()).isEqualTo(UPDATED_CONTACT_NUMBER);
        assertThat(testTeacher.getGender()).isEqualTo(UPDATED_GENDER);
        assertThat(testTeacher.getAddress()).isEqualTo(UPDATED_ADDRESS);
        assertThat(testTeacher.getCreatedOn()).isEqualTo(UPDATED_CREATED_ON);
